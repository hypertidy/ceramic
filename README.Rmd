...
The default map provider is [Mapbox](https://mapbox.com/), but ceramic is written for general usage and also provides access to the [joerd tiles]() via the `type = "elevation-tiles-prod"` argument. 
